...
if(isset($_POST['reset']))
  {
    ...
    $mobile=$_POST['mobile'];
        ...
        $query=mysqli_query($con,"select id from personnel where  email='$email' and mobile='$mobile' ");
    ...
    if($ret>0){
     ...
     header('location:reset-password.php');
      ...
      $msg="Email or phone number is invalid";
    }
  }
  ?>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post" name="reset">
					<span class="login100-form-title">
						KHU VMS
						<p style="color: #ffff;">Password Recovery</p>
					</span>
					...
					<div class="text-right p-t-13 p-b-23">
						<span class="txt1"><i class="fa fa-long-arrow-left"></i>
							Go back
						</span>
